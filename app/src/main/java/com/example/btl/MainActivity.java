...
import com.example.btl.congthuc.CongThucFragment;
import com.example.btl.monhoc.TiengAnhFragment;

import com.example.btl.question.DBHelper;
import com.example.btl.score.ScoreFragment;
import com.example.btl.user.ChangePasswordFragment;
import com.example.btl.user.MyProfileFragment;
import com.example.btl.user.SignInActivity;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final int FRAGMENT_MONTOAN = 1;
    private static final int FRAGMENT_SCORE = 2;
    private static final int FRAGMENT_CONGTHUC = 3;
    private static final int FRAGMENT_MYPROFILE = 4;
    private static final int FRAGMENT_CHANGE_PASSWORD = 5;
    public static final int MY_REQUEST_CODE = 10;


    private int mCurrentFragment = FRAGMENT_MONTOAN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar); // tạo tool bar để hiển thị lên màn hình
...
//        db.deleteDataBase();
    ...
    @Override
    public boolean onNavigationItemSelected(@NonNull MenuItem item) { // xử lý event khi chọn
    ...
    public void showUserInformation() {
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();        // show infor
        if (user == null) {
            return;
        } else {
